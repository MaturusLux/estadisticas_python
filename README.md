...
## :chart_with_upwards_trend:Funciones Básicas de Estadística
![Python](https://img.shields.io/badge/python-000000?style=plastic&logo=python&logoColor=ffdd54)

* [`01 Promedio (Rinde x Lote)`](https://github.com/MaturusLux/estadisticas_python/blob/main/funciones_basicas/01_basico_promedio_rinde.py)

* [`02 Promedio Movil (Cotizaciones)`](https://github.com/MaturusLux/estadisticas_python/blob/main/funciones_basicas/02_basico_promedio_movil.py)

* [`03 Mediana (Lluvias)`](https://github.com/MaturusLux/estadisticas_python/blob/main/funciones_basicas/03_basico_mediana.py)

* [`04 Moda (Averías Maquinarias)`](https://github.com/MaturusLux/estadisticas_python/blob/main/funciones_basicas/04_moda.py)

* [`05 Multimoda (Averías Maquinarias)`](
https://github.com/MaturusLux/estadisticas_python/blob/main/funciones_basicas/05_multimoda.py)

* [`06 Media Geométrica (Cabezas de Ganado)`](
https://github.com/MaturusLux/estadisticas_python/blob/main/funciones_basicas/06_media_geometrica_vs_aritmetica.py)

* [`07 Desvio Estandar Lineal (Precio Hectáreas)`](
https://github.com/MaturusLux/estadisticas_python/blob/main/funciones_basicas/07_desvio_estandar_lineal.py)

* [`07 Desvio Estandar Polimonial  (Demanda de Agroquímicos)`](
https://github.com/MaturusLux/estadisticas_python/blob/main/funciones_basicas/07_desvio_estandar_polinomial.py)

* [`08 Varianza Alta y Baja (Horas de Maquinarias)`](
https://github.com/MaturusLux/estadisticas_python/blob/main/funciones_basicas/08_varianza_altaBaja_coefVariacion.py)


## :chart_with_downwards_trend:Regresiones en Estadística
![Python](https://img.shields.io/badge/python-000000?style=plastic&logo=python&logoColor=ffdd54)

* [`01 Regresion Lineal (Precio Hectáreas de Lote)`](
https://github.com/MaturusLux/estadisticas_python/blob/main/regresiones/01_regresion_lineal_agro.py)

* [`02 Regresión Lineal Múltiple (Precio Hectáreas de Lote)`](
https://github.com/MaturusLux/estadisticas_python/blob/main/regresiones/02_regresion_lineal_multiple.py)

* [`03 Regresion Logística - Dosis Agroquímico Efectiva`](
https://github.com/MaturusLux/estadisticas_python/blob/main/regresiones/03_regresion_logistica.py)

* [`04 Regresion Polinomial - Volatilidad Precio Futuros`](
https://github.com/MaturusLux/estadisticas_python/blob/main/regresiones/04_regresion_polinomial.py)

* [`05 Regresión Binomial Negativa`](
https://github.com/MaturusLux/estadisticas_python/blob/main/regresiones/05_regresion_binomial_negativa.py)

* [`06 Regresión Lasso`](
https://github.com/MaturusLux/estadisticas_python/blob/main/regresiones/06_regresionLasso.py)

* [`07A Regresión Ridge Lineal (Precio de flete)`](
https://github.com/MaturusLux/estadisticas_python/blob/main/regresiones/07_regresion_ridge_lineal.py)

* [`07B Regresión Ridge Logística - Probabilidad de demoras`](
https://github.com/MaturusLux/estadisticas_python/blob/main/regresiones/07_regresion_ridge_logistica.py)

* [`08 Regresion ElasticNet`](
https://github.com/MaturusLux/estadisticas_python/blob/main/regresiones/08_regresion_elasticNet.py)

* [`09 Regresion Poisson`](
https://github.com/MaturusLux/estadisticas_python/blob/main/regresiones/09_regresion_poisson.py)
...
* [`12 Regresion Probit`](
https://github.com/MaturusLux/estadisticas_python/blob/main/regresiones/12_regresion_probit.py)

* [`13 Regresion Theil Sen`](
https://github.com/MaturusLux/estadisticas_python/blob/main/regresiones/13_regresion_theil_sen.py)

* [`14 Regresion Loess Lowess`](
https://github.com/MaturusLux/estadisticas_python/blob/main/regresiones/14_regresion_loess_lowess.py)

## :mega: Aprendizaje Automático Supervisado

* [`01 Análisis Discrimanante Linear`](
https://github.com/MaturusLux/estadisticas_python/blob/main/aprendizaje_automatico/01_LinearDiscriminantAnalysis.py)

* [`02 Árbol de Decisión`](
https://github.com/MaturusLux/estadisticas_python/blob/main/aprendizaje_automatico/02_decision_tree_classifier.py)

* [`03 Random Forest Classifier`](
https://github.com/MaturusLux/estadisticas_python/blob/main/aprendizaje_automatico/03_random_forest_classifier_bagging.py)

* [`04 Gradient Boosting - Classifier`](
https://github.com/MaturusLux/estadisticas_python/blob/main/aprendizaje_automatico/04_gradient_boosting_machine_c.py)

* [`05 Gradient Boosting - Regressor`](
https://github.com/MaturusLux/estadisticas_python/blob/main/aprendizaje_automatico/05_gradient_boosting_machine_r.py)

* [`06 K-Nearest Neighbors`](
https://github.com/MaturusLux/estadisticas_python/blob/main/aprendizaje_automatico/06_k_nearest_neighbors.py)

* [`07 Naives Bayes Gaussian`](
https://github.com/MaturusLux/estadisticas_python/blob/main/aprendizaje_automatico/07_naive_bayes_multinomial.py)

* [`08 Análisis Discriminante Cuadrático`](
https://github.com/MaturusLux/estadisticas_python/blob/main/aprendizaje_automatico/08_quadratic_discriminant_anaysis.py)

## :brain: Aprendizaje Automático No Supervisado
![Python](https://img.shields.io/badge/python-000000?style=plastic&logo=python&logoColor=ffdd54)
